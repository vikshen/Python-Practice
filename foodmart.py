...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 10 13:48:38 2018
...
def generateRules(L, support_data, min_confidence=0.6):
...
def calc_confidence(freqSet, H, support_data, rules, min_confidence=0.6):
...
def rules_from_conseq(freqSet, H, support_data, rules, min_confidence=0.6):
